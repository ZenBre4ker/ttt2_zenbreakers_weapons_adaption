...
-- Standard Set for Assault Rifle "ar"
	...
	SWEP.CloseUpKillDistance	= 200		-- Depending on the CloseUpKillDistance you can oneshot everybody with a headshot in this distance
	SWEP.FallOfDistance			= 400
...
-- Replace Set for Submachine Gun "smg"
	...
	SWEP.Zen["smg"].HeadshotMultiplier	= 2
...
-- Replace Set for Machine Pistol "mp"
	...
	SWEP.Zen["mp"].HeadshotMultiplier	= 2
	...
	SWEP.Zen["mp"].FallOfDistance		= 300
...
-- Replace Set for Light Machine Gun "lmg"
	...
	SWEP.Zen["lmg"].HeadshotMultiplier	= 2
	SWEP.Zen["lmg"].CloseUpKillDistance	= 200		-- Depending on the CloseUpKillDistance you can oneshot everybody with a headshot in this distance
	SWEP.Zen["lmg"].FallOfDistance		= 600
	...
	SWEP.Zen["lmg"].AmmoEnt				= "item_ammo_smg1_ttt"	-- These guns don't get refill Ammo
--
